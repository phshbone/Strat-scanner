...
check("panel count preserves valid two-panel selection",watch.normalizePanelCount("2")===2);
check("panel count preserves valid three-panel selection",watch.normalizePanelCount(3)===3);
check("invalid panel count falls back to one",watch.normalizePanelCount(9)===1&&watch.normalizePanelCount("bad")===1);
