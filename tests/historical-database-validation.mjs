...
(async()=>{
  ...
  const temporal=dbmod.temporalSummary([
    {period:"2026-04",sample_size:12,resolved_sample_size:10,wins:6,losses:4},
    {period:"2026-05",sample_size:9,resolved_sample_size:9,wins:5,losses:4}
  ],{minResolvedPerPeriod:10,minPopulatedPeriods:2});
  ...
  console.log("");
  console.log(pass+"/"+pass+" PASS historical database validation");
