...
(function(){
  ...
  function scriptReady(src){
    ...
    if(src.includes("chart-preferences")) return !!window.StratChartPreferences;
  ...
  async function boot(){
    try{
      ...
      await loadScript("chart-preferences.js");
      ...
      const timer=setInterval(()=>{
        ...
        if(tryWrapRender()){
          ...
          if(window.StratChartPreferences) window.StratChartPreferences.installResearchConsole();
